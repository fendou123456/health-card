<template>
    <div class="flex-column">
        <div class="flex-center" style="margin-top:60px;"><img :src="failurl" alt="" style="width:90px;height:90px;"></div>
        <div class="bold font-size6 color-333 text-align-center margin-top56">授权失败</div>
